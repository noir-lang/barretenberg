...
describe('address', ()=>{
    it('should return correct string', ()=>{
        let address = EthAddress.fromString('0xc6d9d2cd449a754c494264e1809c50e34d64562b');
        ...
        it("should return true for valid prefixed address", ()=>{
            expect(EthAddress.isAddress('0xc6d9d2cd449a754c494264e1809c50e34d64562b')).toBe(!0);
        }), it("should return true for valid unprefixed address", ()=>{
            expect(EthAddress.isAddress('c6d9d2cd449a754c494264e1809c50e34d64562b')).toBe(!0);
        }), it("should return true for valid all uppercase address", ()=>{
            expect(EthAddress.isAddress('0xC6D9D2CD449A754C494264E1809C50E34D64562B')).toBe(!0);
        }), it("should return true for correctly checksummed address", ()=>{
            expect(EthAddress.isAddress('0xE247A45c287191d435A8a5D72A7C8dc030451E9F')).toBe(!0);
        }), it("should return false for badly checksummed address", ()=>{
            expect(EthAddress.isAddress('0xE247A45C287191d435A8a5D72A7C8dc030451E9F')).toBe(!1);
        }), it("should return false for non hex characters", ()=>{
            expect(EthAddress.isAddress('0xg6d9d2cd449a754c494264e1809c50e34d64562b')).toBe(!1);
        });
