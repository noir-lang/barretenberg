...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), Object.defineProperty(exports, "NoteAlgorithms", {
    enumerable: !0,
    get: ()=>NoteAlgorithms
});
...
class NoteAlgorithms {
    ...
    valueNoteNullifierBigInt(noteCommitment, accountPrivateKey, real = !0) {
        return (0, _bigintBuffer.toBigIntBE)(this.valueNoteNullifier(noteCommitment, accountPrivateKey, real));
    }
    ...
    claimNoteCompletePartialCommitment(partialNote, interactionNonce, fee) {
        return this.wasm.transferToHeap(partialNote, 0), this.wasm.transferToHeap((0, _bigintBuffer.toBufferBE)(fee, 32), 32), this.wasm.call('notes__claim_note_complete_partial_commitment', 0, interactionNonce, 32, 0), Buffer.from(this.wasm.sliceMemory(0, 32));
    }
