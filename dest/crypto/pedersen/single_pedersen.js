...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), Object.defineProperty(exports, "SinglePedersen", {
    enumerable: !0,
    get: ()=>SinglePedersen
});
...
class SinglePedersen {
    ...
    compressInputs(inputs) {
        let inputVectors = (0, _serialize.serializeBufferArrayToVector)(inputs);
    ...
    async hashToTree(values) {
        let data = (0, _serialize.serializeBufferArrayToVector)(values), inputPtr = await this.worker.call('bbmalloc', data.length);
        ...
        return await this.worker.call('bbfree', inputPtr), await this.worker.call('bbfree', resultPtr), (0, _serialize.deserializeArrayFromVector)(_serialize.deserializeField, resultData).elem;
    }
